	...
	$.ajax({
		...
		success : function(res){
			...
			for(var i=0 ; i<res.length ; i++){
				$("#WlkRtList").append("<a href=\'ShowWalkingRt.jsp?wlk_rt_nbr="+res[i].wlk_rt_nbr+"&lat="+${param.lat}+"&lon="+${param.lon}+"&wlk_rt_name="+res[i].wlk_rt_name+"'>"+res[i].wlk_rt_name+"'</a><br>");
			}			
		},
		error : function(){
			alert("Ajax 통신 실패!!");	
